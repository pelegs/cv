%% This was taken (with small changes) from the following AMAZING answer on the tex stackoverflow:
%% https://tex.stackexchange.com/a/622797/162087
%% Thanks, egreg!
...
\str_set:Nn \l_fabbri_lc_fallback_str { en } % choose the fallback language
